...
class BreadCrumb extends Component {
    ...
    render() {
        ...
        else if(location.pathname === '/admin/manageevents')  {
            previousPage = <li className="breadcrumb-item"><Link to="/">Admin</Link></li>;
        ...
        if(location.pathname !== '/login' 
            ...
            <div style={{ fontSize: "13px" }}>
                ...
                <ol className="breadcrumb">
                    <li className="breadcrumb-item"><Link to="/productsgridview" onClick={() => this.props.refreshSelectProduct()}>Home</Link></li>
                    {previousPage}
                    {previousPage1}
